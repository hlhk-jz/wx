  ...
  <div class="gj">
    ...
    <div class="wu" id="wu_id">
      ...
      <div id="wu_id_cs" style="width: 99px;float:left;display: none;">
        <div style="margin-top: 7px;">
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(1,12)">标题标提</a><br>
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(2,12)">标题标提</a>
        </div>
      </div>
    </div>
    ...
    <div class="si" id="si_id">
      ...
      <div id="si_id_cs" style="width: 99px;float:left;display: none;">
        <div style="margin-top: 7px;">
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(1,9)">标题标提</a><br>
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(2,9)">标题标提</a>
        </div>
      </div>
    </div>
    ...
    <div class="san" id="san_id">
      ...
      <div id="san_id_cs" style="width: 99px;float:left;display: none;">
        <div style="margin-top: 7px;">
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(1,6)">标题标提</a><br>
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(2,6)">标题标提</a>
        </div>
      </div>
    </div>
