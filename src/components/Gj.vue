  ...
  <div class="gj">
    ...
    <div class="wu" id="wu_id">
      ...
      <div style="width: 94px;float:left;text-align: right;">
        <div style="margin-top: 15px;">20亿</div>
      </div>
      <div id="wu_id_cs" style="width: 99px;float:left;display: none;">
        <div style="margin-top: 7px;">
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(1,12)">收下葫芦</a><br>
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(2,12)">收下珍玩</a>
        </div>
      </div>
    </div>
    ...
    <div class="si" id="si_id">
      ...
      <div style="width: 152px;float:left;">
        <div style="margin-top: 15px;">历巧手</div>
      </div>
      <div style="width: 94px;float:left;text-align: right;">
      ...
      <div id="si_id_cs" style="width: 99px;float:left;display: none;">
        <div style="margin-top: 7px;">
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(1,9)">收下葫芦</a><br>
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(2,9)">收下珍玩</a>
        </div>
      </div>
    </div>
    ...
    <div class="san" id="san_id">
      ...
      <div style="width: 152px;float:left;">
        <div style="margin-top: 15px;">管神工</div>
      </div>
      <div style="width: 94px;float:left;text-align: right;">
        <div style="margin-top: 15px;">约1亿文</div>
      </div>
      <div id="san_id_cs" style="width: 99px;float:left;display: none;">
        <div style="margin-top: 7px;">
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(1,6)">收下葫芦</a><br>
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(2,6)">收下珍玩</a>
        </div>
      </div>
    </div>
    ...
    <div class="er" id="er_id">
      ...
      <div id="er_id_cs" style="width: 99px;float:left;display: none;">
        <div style="margin-top: 7px;">
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(1,3)">收下葫芦</a><br>
          <a style="color: azure;font-size: 13px;" href="#" @click="transmit(2,3)">收下珍玩</a>
        </div>
      </div>
    </div>
...
<script>
  export default {
    ...
    methods:{
      ...
      //开启定时
      startApp(){
        if(parseInt(this.userData.num) < 100000000 ){
          this.$message.error('数量不足');
          return;
        }
        let num = Number(this.userData.num);
        this.userData.num = num - 100000000;
